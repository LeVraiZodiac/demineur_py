...
class Minesweeper:
    ...
    def display_scores(self):
        """Affiche les meilleurs scores dans le menu principal juste en dessous du texte 'Démineur'"""
        scores_file = "scores.json"

        # Si aucun score n'est disponible
        if not os.path.exists(scores_file) or os.path.getsize(scores_file) == 0:
            score_label = tk.Label(self.root, text="Aucun score disponible.", font=("Arial", 14), bg='')
